...
export class VirtualMachineInstance extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.kubevirt.v1.VirtualMachineInstanceSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.kubevirt.v1.VirtualMachineInstanceStatus>;
