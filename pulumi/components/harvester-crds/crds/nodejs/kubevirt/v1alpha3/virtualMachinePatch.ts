...
export class VirtualMachinePatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.kubevirt.v1alpha3.VirtualMachineSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.kubevirt.v1alpha3.VirtualMachineStatusPatch>;
