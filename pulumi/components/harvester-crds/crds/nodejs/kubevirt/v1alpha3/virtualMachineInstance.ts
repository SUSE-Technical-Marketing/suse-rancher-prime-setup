...
export class VirtualMachineInstance extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.kubevirt.v1alpha3.VirtualMachineInstanceSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.kubevirt.v1alpha3.VirtualMachineInstanceStatus>;
