...
export class Addon extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:harvesterhci.io/v1beta1:Addon';
    ...
    declare public readonly spec: pulumi.Output<outputs.harvesterhci.v1beta1.AddonSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.harvesterhci.v1beta1.AddonStatus>;
