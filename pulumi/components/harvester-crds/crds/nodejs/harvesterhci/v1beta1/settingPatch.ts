...
export class SettingPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:harvesterhci.io/v1beta1:SettingPatch';
    ...
    declare public /*out*/ readonly status: pulumi.Output<outputs.harvesterhci.v1beta1.SettingStatusPatch>;
