...
export class IPPool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:loadbalancer.harvesterhci.io/v1beta1:IPPool';
    ...
    declare public readonly spec: pulumi.Output<outputs.loadbalancer.v1beta1.IPPoolSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.loadbalancer.v1beta1.IPPoolStatus>;
    ...
    constructor(name: string, args?: IPPoolArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:network.harvesterhci.io/v1alpha1:IPPool" }] };
