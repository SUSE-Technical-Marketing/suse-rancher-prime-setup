 ...
 */
export class IPPoolPatch extends pulumi.CustomResource {
    /**
     * Get an existing IPPoolPatch resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): IPPoolPatch {
        return new IPPoolPatch(name, undefined as any, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is IPPoolPatch {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === IPPoolPatch.__pulumiType;
    }
     ...
     */
    declare public readonly kind: pulumi.Output<"IPPool">;
    /**
     ...
     */
    constructor(name: string, args?: IPPoolPatchArgs, opts?: pulumi.CustomResourceOptions) {
...
/**
 * The set of arguments for constructing a IPPoolPatch resource.
 */
export interface IPPoolPatchArgs {
    /**
     * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
     */
