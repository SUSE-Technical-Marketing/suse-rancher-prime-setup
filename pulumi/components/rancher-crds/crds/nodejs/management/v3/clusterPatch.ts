...
export class ClusterPatch extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.management.v3.ClusterSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.management.v3.ClusterStatusPatch>;
