...
export class ClusterGroup extends pulumi.CustomResource {
    ...
    public readonly spec!: pulumi.Output<outputs.fleet.v1alpha1.ClusterGroupSpec>;
    public /*out*/ readonly status!: pulumi.Output<outputs.fleet.v1alpha1.ClusterGroupStatus>;
