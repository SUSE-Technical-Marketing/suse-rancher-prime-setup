...
export class ClusterPatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:provisioning.cattle.io/v1:ClusterPatch';
     ...
     */
    public readonly apiVersion!: pulumi.Output<"provisioning.cattle.io/v1">;
    /**
    ...
    public readonly spec!: pulumi.Output<outputs.provisioning.v1.ClusterSpecPatch>;
    public /*out*/ readonly status!: pulumi.Output<outputs.provisioning.v1.ClusterStatusPatch>;
    ...
    constructor(name: string, args?: ClusterPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:management.cattle.io/v3:ClusterPatch" }] };
...
export interface ClusterPatchArgs {
    ...
    spec?: pulumi.Input<inputs.provisioning.v1.ClusterSpecPatch>;
}
