...
export class ClusterPatch extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.provisioning.v1.ClusterSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.provisioning.v1.ClusterStatusPatch>;
