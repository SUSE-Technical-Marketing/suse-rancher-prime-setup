...
export class Cluster extends pulumi.CustomResource {
    ...
    declare public readonly spec: pulumi.Output<outputs.provisioning.v1.ClusterSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.provisioning.v1.ClusterStatus>;
