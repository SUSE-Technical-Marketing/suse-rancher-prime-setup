...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "kubernetes:provisioning.cattle.io/v1:Cluster":
                return new Cluster(name, <any>undefined, { urn })
            case "kubernetes:provisioning.cattle.io/v1:ClusterList":
                return new ClusterList(name, <any>undefined, { urn })
            case "kubernetes:provisioning.cattle.io/v1:ClusterPatch":
...
pulumi.runtime.registerResourceModule("crds", "provisioning.cattle.io/v1", _module)
