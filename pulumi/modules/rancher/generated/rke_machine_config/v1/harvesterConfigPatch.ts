 ...
 */
export class HarvesterConfigPatch extends pulumi.CustomResource {
    /**
     * Get an existing HarvesterConfigPatch resource's state with the given name, ID, and optional extra
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): HarvesterConfigPatch {
        return new HarvesterConfigPatch(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:rke-machine-config.cattle.io/v1:HarvesterConfigPatch';

    /**
     * Returns true if the given object is an instance of HarvesterConfigPatch.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is HarvesterConfigPatch {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === HarvesterConfigPatch.__pulumiType;
    }
    ...
    /**
     * Create a HarvesterConfigPatch resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args?: HarvesterConfigPatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(HarvesterConfigPatch.__pulumiType, name, resourceInputs, opts);
    }
}

/**
 * The set of arguments for constructing a HarvesterConfigPatch resource.
 */
export interface HarvesterConfigPatchArgs {
    /**
     * APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
     */
