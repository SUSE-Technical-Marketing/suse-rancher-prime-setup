...
export class ClusterGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ClusterGroup {
        return new ClusterGroup(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:fleet.cattle.io/v1alpha1:ClusterGroup';
    ...
    declare public readonly spec: pulumi.Output<outputs.fleet.v1alpha1.ClusterGroupSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.fleet.v1alpha1.ClusterGroupStatus>;
