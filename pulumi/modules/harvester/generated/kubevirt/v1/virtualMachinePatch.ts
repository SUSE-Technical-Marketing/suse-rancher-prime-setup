...
export class VirtualMachinePatch extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:kubevirt.io/v1:VirtualMachinePatch';
     ...
     */
    declare public readonly kind: pulumi.Output<"VirtualMachine">;
    /**
     * Standard object's metadata. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
    declare public readonly metadata: pulumi.Output<outputs.meta.v1.ObjectMetaPatch>;
    declare public readonly spec: pulumi.Output<outputs.kubevirt.v1.VirtualMachineSpecPatch>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.kubevirt.v1.VirtualMachineStatusPatch>;
    ...
    constructor(name: string, args?: VirtualMachinePatchArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:kubevirt.io/v1alpha3:VirtualMachinePatch" }] };
...
export interface VirtualMachinePatchArgs {
    ...
    spec?: pulumi.Input<inputs.kubevirt.v1.VirtualMachineSpecPatch>;
}
