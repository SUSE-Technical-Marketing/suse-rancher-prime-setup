...
export class VirtualMachineInstance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:kubevirt.io/v1alpha3:VirtualMachineInstance';
    ...
    declare public readonly spec: pulumi.Output<outputs.kubevirt.v1alpha3.VirtualMachineInstanceSpec>;
    declare public /*out*/ readonly status: pulumi.Output<outputs.kubevirt.v1alpha3.VirtualMachineInstanceStatus>;
    ...
    constructor(name: string, args?: VirtualMachineInstanceArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "kubernetes:kubevirt.io/v1:VirtualMachineInstance" }] };
