...
import { cert_manager } from "../generated/cert-manager";
...
export class TLS extends pulumi.ComponentResource {
    ...
    public readonly certificate?: cert_manager.v1.Certificate;
    ...
    private installCertManager(certManager: CertManagerArgs, opts: pulumi.ComponentResourceOptions): cert_manager.v1.Certificate | undefined {
    ...
    private setupClusterIssuer(ns: pulumi.Input<string>, name: string, url: string, certManager: CertManagerArgs, apiToken: k8s.core.v1.Secret, opts?: pulumi.ComponentResourceOptions): cert_manager.v1.ClusterIssuer {
        return new cert_manager.v1.ClusterIssuer(name, {
                metadata: {
                    name: name,
    ...
    private createWildcardCertificate(ns: pulumi.Input<string>, ci: cert_manager.v1.ClusterIssuer, certManager: CertManagerArgs, opts?: pulumi.ComponentResourceOptions): cert_manager.v1.Certificate {
        // Install wildcard certificate for the specified domain
        return new cert_manager.v1.Certificate(WildcardCertificateSecretName, {
            metadata: {
